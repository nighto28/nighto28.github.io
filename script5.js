...
const maxSpeed = 5;
const friction = 0.9;
const landingThreshold = 7.3; // Sensitivity threshold for landing
...
function resetPlayerPosition() {
  playerX = 490; // Starting X position
  playerY = 410;  // Starting Y position
  playerVelocityX = 0;
  playerVelocityY = 0;
}
...
function gameLoop() {
  ...
  if (isColliding(playerRect, flagRect)) {
    ...
    window.location.href = 'lvl6.html'
    levelComplete();
  }
